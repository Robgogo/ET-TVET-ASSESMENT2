...
@section('content')
  @if(Auth::check())
    @if(\App\Http\Controllers\UserControlPermissionController::hasItemSummaryPermission(Auth::user()))
      <div class="row">
      ...
      <?php $title="Sector Summarry"; ?>
        <a href="/summary/export/items"><span class="glyphicon glyphicon-export"></span> Export To Excel</a>
      </div>
      <hr>
